...
final class QuestionDetailViewController: UIViewController {
    ...
    let question1Contents: [String: Any] = [
        ...
        "answerDescription": "새로운 셔틀에 동참하고 싶으시면 현재 참여중인 셔틀을 탈퇴한 후, 새로운 카풀을 생성 또는 새로운 셔틀에 초대코드 입력 후 참여할 수 있습니다."
    ]
    let question2Contents: [String: Any] = [
        ...
        ◦ 기사님의 경우: 출발 30분 전까지 오늘의 카풀 운행 여부를 응답해주지 않으면 자동으로 카풀이 없음 처리가 됩니다.
        ◦ 탑승자의 경우: 출발 20분 전까지 오늘의 카풀 탑승 여부를 응답해주지 않으면 자동으로 카풀 탑승예정 처리가 됩니다.
    ...
    let question3Contents: [String: Any] = [
        ...
        "answerDescription":
        """
        카뮤는 금전적 이해관계를 기반하지 아니한 셔틀 에서의 불편한 상황과 소통의 어려움을 도와주는 앱입니다.
